...
static struct key keys_full[], keys_full_wide[], keys_special[], keys_specialpad[], keys_simple[],
  ...
  keys_compose_cyr_k[], keys_dialer[], keys_index[], keys_hhkb_fn[], keys_hhkb_dvorak[], keys_hhkb_dvorak_fn[];
...
static struct layout layouts[NumLayouts] = {
  ...
  [HhkbFn] = {keys_hhkb_fn, "latin", "hhkbfn", false},
  [HhkbDvorak] = {keys_hhkb_dvorak, "latin", "hhkbdvorak", true},
  [HhkbDvorakFn] = {keys_hhkb_dvorak_fn, "latin", "hhkbdvorakfn", false},
...
static struct key keys_full[] = {
  ...
  {"[", "{", 1.0, Code, KEY_LEFTBRACE, &layouts[ComposeMath]},
  {"]", "}", 1.0, Code, KEY_RIGHTBRACE, &layouts[ComposeMath]},
  {"`", "~", 1.0, Code, KEY_GRAVE},
  ...
  {"Fn", "Fn", 0.75, Layout, 0, &layouts[HhkbFn], .scheme = 1},
...
static struct key keys_hhkb_fn[] = {
  {"Esc", "Esc", 1.0, Code, KEY_ESC, .scheme = 1},
  ...
  {"Tab", "Tab", 1.5, Code, KEY_TAB, .scheme = 1},
  {"Home", "Home", 1.0, Code, KEY_HOME},
  {"↑", "↑", 1.0, Code, KEY_UP},
  {"End", "End", 1.0, Code, KEY_END},
  ...
  {".", ">", 1.0, Code, KEY_DOT, &layouts[ComposePunctuation]},
  {"/", "?", 1.0, Code, KEY_SLASH, &layouts[ComposePunctuation]},
  {"Dv", "Dv", 1.75, Layout, 0, &layouts[HhkbDvorak]},
  {"", "", 0.0, EndRow},
...
static struct key keys_hhkb_dvorak[] = {
  {"Esc", "Esc", 1.0, Code, KEY_ESC, .scheme = 1},
  {"1", "!", 1.0, Code, KEY_1},
  {"2", "@", 1.0, Code, KEY_2},
  {"3", "#", 1.0, Code, KEY_3},
  ...
  {"Tab", "Tab", 1.5, Code, KEY_TAB, .scheme = 1},
  {"'", "\"", 1.0, Code, KEY_APOSTROPHE, &layouts[Emoji]},
  {",", "<", 1.0, Code, KEY_COMMA, &layouts[ComposeW]},
  {".", ">", 1.0, Code, KEY_DOT, &layouts[ComposeE]},
  {"p", "P", 1.0, Code, KEY_P, &layouts[ComposeR]},
  {"y", "Y", 1.0, Code, KEY_Y, &layouts[ComposeT]},
  {"f", "F", 1.0, Code, KEY_F, &layouts[ComposeY]},
  {"g", "G", 1.0, Code, KEY_G, &layouts[ComposeU]},
  {"c", "C", 1.0, Code, KEY_C, &layouts[ComposeI]},
  {"r", "R", 1.0, Code, KEY_R, &layouts[ComposeO]},
  {"l", "L", 1.0, Code, KEY_L, &layouts[ComposeP]},
  {"/", "?", 1.0, Code, KEY_SLASH, &layouts[ComposeBracket]},
  ...
  {"Ctr", "Ctr", 1.5, Mod, Ctrl, .scheme = 1},
  {"a", "A", 1.0, Code, KEY_A, &layouts[ComposeA]},
  {"o", "O", 1.0, Code, KEY_O, &layouts[ComposeS]},
  {"e", "E", 1.0, Code, KEY_E, &layouts[ComposeD]},
  {"u", "U", 1.0, Code, KEY_U, &layouts[ComposeF]},
  {"i", "I", 1.0, Code, KEY_I, &layouts[ComposeG]},
  {"d", "D", 1.0, Code, KEY_D, &layouts[ComposeH]},
  {"h", "H", 1.0, Code, KEY_H, &layouts[ComposeJ]},
  {"t", "T", 1.0, Code, KEY_T, &layouts[ComposeK]},
  {"n", "N", 1.0, Code, KEY_N, &layouts[ComposeL]},
  {"s", "S", 1.0, Code, KEY_S, &layouts[ComposePunctuation]},
  {"-", "_", 1.0, Code, KEY_MINUS, &layouts[ComposeBracket]},
  {"Enter", "Enter", 1.5, Code, KEY_ENTER, .scheme = 1},
  {"", "", 0.0, EndRow},

  {"⇧", "⇫", 1.75, Mod, Shift, .scheme = 1},
  {";", ":", 1.0, Code, KEY_SEMICOLON, &layouts[ComposeZ]},
  {"q", "Q", 1.0, Code, KEY_Q, &layouts[ComposeX]},
  {"j", "J", 1.0, Code, KEY_J, &layouts[ComposeC]},
  {"k", "K", 1.0, Code, KEY_K, &layouts[ComposeV]},
  {"x", "X", 1.0, Code, KEY_X, &layouts[ComposeB]},
  {"b", "B", 1.0, Code, KEY_B, &layouts[ComposeN]},
  {"m", "M", 1.0, Code, KEY_M, &layouts[ComposeM]},
  {"w", "W", 1.0, Code, KEY_W, &layouts[ComposeMath]},
  {"v", "V", 1.0, Code, KEY_V, &layouts[ComposePunctuation]},
  {"z", "Z", 1.0, Code, KEY_Z, &layouts[ComposePunctuation]},
  {"⇧", "⇫", 1.75, Mod, Shift, .scheme = 1},
  {"", "", 0.0, EndRow},
  ...
  {"Alt", "Alt", 1.0, Mod, Alt, .scheme = 1},
  {"", "Tab", 6.0, Code, KEY_SPACE},
  {"Fn", "Fn", 0.75, Layout, 0, &layouts[HhkbDvorakFn]},
  {"Sup", "Sup", 0.75, Mod, Super, .scheme = 1},
  {"←", "←", 0.75, Code, KEY_LEFT, .scheme = 1},
  {"↓", "↓", 0.75, Code, KEY_DOWN, .scheme = 1},
  {"↑", "↑", 0.75, Code, KEY_UP, .scheme = 1},
...
static struct key keys_hhkb_dvorak_fn[] = {
  {"Esc", "Esc", 1.0, Code, KEY_ESC, .scheme = 1},
  {"F1", "F1", 1.0, Code, KEY_F1},
  {"F2", "F2", 1.0, Code, KEY_F2},
  {"F3", "F3", 1.0, Code, KEY_F3},
  ...
  {"v", "V", 1.0, Code, KEY_V, &layouts[ComposePunctuation]},
  {"z", "Z", 1.0, Code, KEY_Z, &layouts[ComposePunctuation]},
  {"Qw", "Qw", 1.75, Layout, 0, &layouts[Landscape]},
  {"", "", 0.0, EndRow},
  ...
  {"Alt", "Alt", 1.0, Mod, Alt, .scheme = 1},
  {"", "Tab", 6.0, Code, KEY_SPACE},
  {"Fn", "Fn", 0.75, Layout, 0, &layouts[HhkbDvorak]},
  {"Sup", "Sup", 0.75, Mod, Super, .scheme = 1},
  {"←", "←", 0.75, Code, KEY_LEFT, .scheme = 1},
  {"↓", "↓", 0.75, Code, KEY_DOWN, .scheme = 1},
  {"↑", "↑", 0.75, Code, KEY_UP, .scheme = 1},
